                    ...
                    <tbody>
                        ...
                        <form action="{{ route('check_store') }}" method="post">
                            ...
                            @foreach ($employees as $employee)
                                ...
                                <tr>
                                    <td><li class="dropdown notification-list">
                                        <div class="dropdown notification-list nav-pro-img">
                                            <a class="dropdown-toggle nav-link arrow-none waves-effect nav-user" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                                <img src="assets/images/profile2.jpg" alt="user" class="rounded-circle">
                                            </a>
                                            <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                                                <!-- item-->
                                                <a class="dropdown-item" href="#">
                                                    <i class="mdi mdi-account-circle m-r-5"></i>
                                                    <img src="assets/images/profile2.jpg" alt="user" class="rounded-circle" style="width: 500px; height: 500px;">
                                                </a>
